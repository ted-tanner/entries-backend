...
mod tests {
    ...
    use crate::handlers::request_io::{
        ...
        OutputBudget, SigninToken, SigninTokenOtpPair, TokenPair,
    };
	...
	let fetched_budget_req = test::TestRequest::post()
        ...
        let budget = serde_json::from_str::<OutputBudget>(fetched_budget_res_body.as_str()).unwrap();
    ...
    // TODO: Test can't access budget for another user (test with *all* of the "get" budget handlers)
}
